...
// searchParams is injected by Next.js for you in server components/pages.
// You only need useSearchParams in client components.
// You can remove the Promise and await from your code for searchParams

// In Next.js (especially in the App Router with server components), the searchParams prop is automatically injected by the framework into your page component when you define it in the function signature.
